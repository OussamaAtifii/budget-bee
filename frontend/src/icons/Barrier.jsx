const Barrier = (props) => (
  ...
  >
    ...
    <path d="M7 16v4"></path> <path d="M7.5 16l4.244 -4.244"></path>{' '}
    <path d="M13.745 9.755l2.755 -2.755"></path>{' '}
    <path d="M13.5 16l1.249 -1.249"></path>{' '}
    <path d="M16.741 12.759l3.259 -3.259"></path>{' '}
    <path d="M4 13.5l4.752 -4.752"></path> <path d="M17 17v3"></path>{' '}
    <path d="M5 20h4"></path> <path d="M15 20h4"></path>{' '}
    <path d="M17 7v-2"></path> <path d="M3 3l18 18"></path>{' '}
  </svg>
)
